function initHowItWasMade() {
    ...
    style.textContent = `
        ...
        .hiwm-card {
            ...
            filter: url(#goo); transition: 0.3s;
        }
        .hiwm-card:hover {
        ...
        .hiwm-prompt {
            background: rgba(0, 0, 0, 0.8); border: 1px solid rgba(0, 255, 102, 0.2);
            padding: 15px; font-size: 11px;
            color: #0f6; margin-bottom: 20px; line-height: 1.6; opacity: 0.7;
        }
    ...
    overlay.innerHTML = `
        ...
        <div style="background:rgba(0,255,102,0.02); border:1px solid rgba(0,255,102,0.1); padding:40px; border-radius:4px; text-align:center; margin: 60px auto 100px auto; max-width:700px; width:90%; filter:url(#goo);">
            ...
            <a href="https://github.com/jordan-thirkle/blobz-io-v2" target="_blank" style="display:inline-block; padding:15px 40px; background:var(--cyan); color:#000; text-decoration:none; font-weight:900; transition:0.3s; font-family:'Orbitron'; letter-spacing:2px; box-shadow: 0 0 30px rgba(0,255,102,0.3);">ESTABLISH_UPLINK</a>
        </div>
